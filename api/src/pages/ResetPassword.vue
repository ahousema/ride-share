<template>
  <v-container>
    <div>
      ...
      <instructions details="Change your nifty password to be even niftier." />
      ...
      <v-form v-model="valid">
        ...
        <v-text-field
          v-model="updateMember.oldPassword"
        ...
        <v-text-field
          ...
          error-count="10"
          type="password"
          label="Non-trivial new password"
          required
        >
        </v-text-field>
        <v-text-field
...
export default {
  ...
  methods: {
    ...
    handleSubmit: function () {
      ...
      this.$axios
        .patch("/accounts/{this.updateMember.email}", {
          oldPassword: this.updateMember.oldPassword,
